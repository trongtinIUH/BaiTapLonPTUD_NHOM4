...
public class GD_ThongKe extends JPanel {
	...
	public GD_ThongKe() {
		...
		cbThongKe.setFont(new Font("Arial", Font.BOLD, 18));
		...
		cbDate.addItem("Năm");
		cbDate.setFont(new Font("Arial", Font.BOLD, 18));
		...
		lblDoanhThuPhongThuong.setFont(new Font("Arial", Font.BOLD, 18));
		...
		lblDoanhThuPhongVIP.setFont(new Font("Arial", Font.BOLD, 18));
		...
		lblTongSoGioHat.setFont(new Font("Arial", Font.BOLD, 18));
