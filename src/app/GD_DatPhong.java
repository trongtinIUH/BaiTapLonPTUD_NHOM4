...
public class GD_DatPhong extends JPanel implements ActionListener, MouseListener {
	...
	public GD_DatPhong() {
		...
		panel_3.setBounds(0, 138, 1080, 530);
		panel.add(panel_3);
		panel_3.setLayout(null);
		
		scrollPane_Phong = new JScrollPane();
		scrollPane_Phong.setBounds(0, 0, 1080, 530);
		panel_3.add(scrollPane_Phong);
		
        // Tạo JPanel bên ngoài với kích thước cố định
        outerPanel = new JPanel();
        outerPanel.setPreferredSize(new Dimension(1080, 800));
        outerPanel.setLayout(null);
        

        JPanel panel_ChuaPhong = new JPanel();
        panel_ChuaPhong.setBounds(0, 0, 1080, 1000);
      ...
      Image resizedImage_phongtrong = originalImage_phongtrong.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongsd = originalImage_phongsd.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongcho = originalImage_phongcho.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongsua = originalImage_phongsua.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongtrongvip = originalImage_phongtrongvip.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongsdvip = originalImage_phongsdvip.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongchovip = originalImage_phongchovip.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
      ...
      Image resizedImage_phongsuavip = originalImage_phongsuavip.getScaledInstance(50, 50, java.awt.Image.SCALE_SMOOTH);
...
//hàng 5
        ...
        btnPhong501.setBounds(40, 550, 150, 100);
        ...
        btnPhong502.setBounds(250, 550, 150, 100);
        ...
        btnPhong503.setBounds(450, 550, 150, 100);
        ...
        btnPhong504.setBounds(650, 550, 150, 100);
        ...
        btnPhong505.setBounds(850, 550, 150, 100);
