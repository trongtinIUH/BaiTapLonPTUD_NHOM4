...
//		Styling Info
		...
		txtMaHD.setFont(new Font("Arial", Font.BOLD, 18));
		...
		txtMaKH.setFont(new Font("Arial", Font.BOLD, 18));
		...
		txtMaNV.setFont(new Font("Arial", Font.BOLD, 18));
		...
		cbTrangThai.setFont(new Font("Arial", Font.BOLD, 18));
		...
		txtKhuyenMai.setFont(new Font("Arial", Font.BOLD, 18));
